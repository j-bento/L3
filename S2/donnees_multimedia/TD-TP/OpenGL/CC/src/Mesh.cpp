...
void Mesh::smooth( float lambda ){
    ...
    for (size_t i = 0; i < vertices.size(); i++){
        ...
        {
            moy= moy + vertices[voisins[i][j]].position;
        }
