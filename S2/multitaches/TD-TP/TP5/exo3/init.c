...
/*
 ...
 valeur corerspond à la derniére zone traitée par le processus
 P_(i+1))
...
int main(int argc, char * argv[]){
  ...
  // création et initialisation du segment de mémoire partagà :

  // on réutilise la méme clà puisque la numérotation des IPC dépend du type d'objet.
